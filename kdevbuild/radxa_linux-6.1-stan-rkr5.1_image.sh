...
export BUILD_TAG="MAXHUB-VX60_linux-6.1-stan-rkr5.1_${set_rootfs}"
...
wget -c https://github.com/yifengyou/MAXHUB-VX60/releases/download/radxa_linux-6.1-stan-rkr5.1_kernel/uboot.img
ls -alh uboot.img
...
wget -c https://github.com/yifengyou/MAXHUB-VX60/releases/download/radxa_linux-6.1-stan-rkr5.1_kernel/Image
ls -alh Image
md5sum Image

wget -c https://github.com/yifengyou/MAXHUB-VX60/releases/download/radxa_linux-6.1-stan-rkr5.1_kernel/config-6.1-kdev
ls -alh config-6.1-kdev
md5sum config-6.1-kdev

wget -c https://github.com/yifengyou/MAXHUB-VX60/releases/download/radxa_linux-6.1-stan-rkr5.1_kernel/System.map-6.1-kdev
ls -alh System.map-6.1-kdev
md5sum System.map-6.1-kdev

wget -c https://github.com/yifengyou/MAXHUB-VX60/releases/download/radxa_linux-6.1-stan-rkr5.1_kernel/rk3588-owl-ai-box-plus-v10.dtb
ls -alh rk3588-owl-ai-box-plus-v10.dtb
md5sum rk3588-owl-ai-box-plus-v10.dtb

wget -c https://github.com/yifengyou/MAXHUB-VX60/releases/download/radxa_linux-6.1-stan-rkr5.1_kernel/kos.tar.gz
ls -alh kos.tar.gz
md5sum kos.tar.gz
tar -xf kos.tar.gz
